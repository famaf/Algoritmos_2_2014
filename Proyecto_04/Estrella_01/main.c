...
// MUESTRO LA CANTIDAD DE COMPONENTES CONEXAS, SI ESTAS SON MAS DE UNA    
    if (union_find_class_count(uf) > 1) {
        fprintf(stderr, "Cantidad de componentes conexas: %u\n",
                union_find_class_count(uf));
    }
