...
union_find_t union_find_union(union_find_t uf, union_find_class_t class1,
    ...
    if (uf->array[class1] >= uf->array[class2]) {
        uf->array[class2] = uf->array[class1] + uf->array[class2];
        uf->array[class1] = class2;
    } else {
        uf->array[class1] = uf->array[class1] + uf->array[class2];
        uf->array[class2] = class1;
    }
