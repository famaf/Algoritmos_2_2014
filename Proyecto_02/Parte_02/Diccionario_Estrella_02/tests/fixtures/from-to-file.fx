...
# }
> {\s*rojo: De color parecido al del oro\s*azul: Del color del cielo sin nubes\s*amarillo: De color semejante al del oro, la flor de la retama\s*}
...
# amarillo: De color semejante al del oro, la flor de la retama
# }
> {\s*rojo: De color parecido al del oro\s*amarillo: De color semejante al del oro, la flor de la retama\s*}
